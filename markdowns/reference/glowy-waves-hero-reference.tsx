// REFERENSI DESAIN — adaptasi sebelum dipakai (lihat landing-page-spec.md §S1 + prompt L2).
// Sumber: komponen "GlowyWavesHero" (shadcn-style, framer-motion + canvas 2D).
// Dependensi: framer-motion, lucide-react (sudah ada di stack).
// CATATAN ADAPTASI LOCALYZE:
// - Import Button dari "@/components/ui/button" DIGANTI komponen Button milik sendiri
//   (project ini bukan shadcn) — styling setara: primary rounded-full & outline.
// - Komponen membaca CSS vars shadcn (--background, --primary, --accent, --secondary,
//   --muted, --foreground). Definisikan vars ini di globals.css, dipetakan ke palet
//   Localyze (primary #1D4ED8, accent cyan #22D3EE, background white/slate-50).
// - Copy, pills, stats, dan CTA diganti konten Localyze (lihat spec §S1).
// - Reduced motion: gambar SATU frame statis lalu hentikan RAF loop (komponen asli
//   hanya mengecilkan parameter tapi tetap animasi — perbaiki saat integrasi).
