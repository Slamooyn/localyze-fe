// @ts-nocheck
// [ARSIP — TIDAK DIPAKAI] Hero landing diganti GlowyWavesHero + ContainerScroll
// (lihat landing-page-spec.md v3). File disimpan untuk referensi masa depan.
// REFERENSI DESAIN — jangan dipakai mentah.
// Sumber: komponen "CinematicHero" (21st.dev-style, GSAP + ScrollTrigger).
// Cara adaptasi ke Localyze: lihat landing-page-spec.md §S1 dan
// claude-code-prompt-landing.md milestone L2.
// Dependensi: npm i gsap  ·  butuh util cn() di src/lib/utils.ts (clsx + tailwind-merge).
    ...
    >
      ...
      <div className="cta-wrapper absolute z-10 flex flex-col items-center justify-center text-center w-screen px-4 gsap-reveal pointer-events-auto will-change-transform">
        ...
        <div className="flex flex-col sm:flex-row gap-6">
          {/* CATATAN ADAPTASI LOCALYZE: dua tombol store di bawah ini DIGANTI menjadi
              "Coba demo gratis" (btn-modern-light → /register) dan
              "Masuk" (btn-modern-dark → /login). Lihat prompt L2. */}
      ...
      <div className="absolute inset-0 z-20 flex items-center justify-center pointer-events-none" style={{ perspective: "1500px" }}>
        ...
        >
          ...
          <div className="relative w-full h-full max-w-7xl mx-auto px-4 lg:px-12 flex flex-col justify-evenly lg:grid lg:grid-cols-3 items-center lg:gap-8 z-10 py-6 lg:py-0">
            ...
            {/* CATATAN ADAPTASI LOCALYZE: blok mockup iPhone di bawah ini DIGANTI
                dengan BrowserFrame berisi mini dashboard Localyze.
                progress-ring + counter-val DIPERTAHANKAN (jadi ScoreDial),
                phone-widget rows jadi FactorRow mini. Lihat prompt L2. */}
