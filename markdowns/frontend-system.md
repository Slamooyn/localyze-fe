...
3. **`landing-page-spec.md` (v2)** — spec landing interaktif (`/`): hero MiniMap, What you get, tutorial sneak peek (scrollytelling tour), Metodologi & Rumus + WeightPlayground, CTA → register.
